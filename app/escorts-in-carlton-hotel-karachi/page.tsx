...
export default function CarltonHotelEscortsPage() {
    ...
    <main className="bg-white text-black font-sans overflow-hidden">
      ...
      <section className="relative h-screen flex items-center justify-center pt-20">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
          ...
          <h2 className="text-3xl md:text-4xl font-medium text-white/90 mt-3">
            Escorts in Carlton Hotel Karachi
          </h2>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-center mb-8">Escorts in Carlton Hotel Karachi</h2>
          <div className="prose prose-lg max-w-4xl mx-auto text-black/80 leading-relaxed space-y-6">
            <p>
              Looking for Escorts in Carlton Hotel Karachi? You’re in the right place. 
              At Pakistan Models Hub, we specialize in providing premium, professional, and discreet escort services 
              for guests at Carlton Hotel and surrounding areas.
            </p>
            <p>
              Carlton Hotel Karachi is known for its upscale environment and VIP clientele. 
              Our Carlton Hotel Escorts offer professional companionship to enhance your stay with elegance, discretion, and unmatched service.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-zinc-50">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-center mb-12">Why Choose Escorts in Carlton Hotel Karachi?</h2>
          <div className="grid md:grid-cols-2 gap-10">
            <div className="space-y-8">
              <div>
                <h3 className="font-semibold text-xl mb-2">Professional & Experienced Girls</h3>
                <p className="text-black/70">All our escorts are trained to provide a memorable and enjoyable experience.</p>
              </div>
              <div>
                <h3 className="font-semibold text-xl mb-2">VIP & Affordable Options</h3>
                <p className="text-black/70">From high-end VIP escorts to more budget-friendly call girls.</p>
              </div>
              <div>
                <h3 className="font-semibold text-xl mb-2">Discreet & Safe Services</h3>
                <p className="text-black/70">Your privacy is our top priority. All bookings are fully confidential.</p>
              </div>
            </div>
            <div className="space-y-8">
              <div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-12 gap-12 items-center">
            <div className="md:col-span-7">
              <h2 className="text-4xl font-bold mb-10">Types of Escorts in Carlton Hotel Karachi</h2>
              <div className="space-y-8">
                <div>
      ...
      <section className="py-20 bg-zinc-50">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-center mb-12">Areas We Cover Near Carlton Hotel</h2>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-center mb-12">Pricing for Escorts in Carlton Hotel Karachi</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[23,24,25,26,27,28,29,30].map((n) => (
              <div key={n} className="relative aspect-square rounded-3xl overflow-hidden shadow-lg">
                <Image 
                  src={`/m${n}.jpg`} 
                  alt="Carlton Hotel Escorts Karachi" 
                  fill 
      ...
      <section className="py-24 bg-black text-white text-center">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-5xl font-bold tracking-tighter mb-6">Ready to Book Escorts in Carlton Hotel Karachi?</h2>
