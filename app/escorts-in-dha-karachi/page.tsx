    ...
    <main className="bg-white text-black font-sans overflow-hidden">
      ...
      <section className="relative h-screen flex items-center justify-center pt-20">
        <div className="absolute inset-0 z-0">
          <Image 
            src="/m18.jpg" 
            alt="Escorts in DHA Karachi - Premium VIP Companions"
            fill 
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-center mb-8">Escorts in DHA Karachi</h2>
          <div className="prose prose-lg max-w-4xl mx-auto text-black/80 leading-relaxed space-y-6">
            <p>
              Looking for Escorts in DHA Karachi? You are at the right place. 
              At Pakistan Models Hub, we provide premium, professional, and discreet escort services 
              across all DHA Karachi areas.
            </p>
            <p>
              DHA Karachi is one of the most exclusive and upscale neighborhoods in the city. 
              Our DHA Karachi Escorts ensure elegance, privacy, and top-notch service in every meeting.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-zinc-50">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-center mb-12">Why Choose Escorts in DHA Karachi?</h2>
          <div className="grid md:grid-cols-2 gap-10">
            <div className="space-y-8">
              <div>
                <h3 className="font-semibold text-xl mb-2">Professional & Experienced Girls</h3>
                <p className="text-black/70">Trained, elegant, and charming escorts ready to provide an unforgettable experience.</p>
              </div>
              <div>
                <h3 className="font-semibold text-xl mb-2">VIP & Affordable Options</h3>
                <p className="text-black/70">From luxurious VIP escorts to affordable call girls for every budget.</p>
              </div>
              <div>
                <h3 className="font-semibold text-xl mb-2">Discreet & Safe Services</h3>
                <p className="text-black/70">Complete privacy and confidentiality guaranteed.</p>
              </div>
            </div>
            <div className="space-y-8">
              <div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-12 gap-12 items-center">
            <div className="md:col-span-7">
              <h2 className="text-4xl font-bold mb-10">Types of Escorts in DHA Karachi</h2>
              <div className="space-y-8">
                <div>
                  <h3 className="font-semibold text-xl mb-3">VIP Escorts</h3>
                  <p className="text-black/70">High-class, elegant companions for luxurious experiences.</p>
                </div>
                <div>
                  <h3 className="font-semibold text-xl mb-3">Hotel Escorts</h3>
                  <p className="text-black/70">Discreet services available in luxury hotels across DHA.</p>
                </div>
                <div>
                  <h3 className="font-semibold text-xl mb-3">House Visit Escorts</h3>
                  <p className="text-black/70">Private home-based bookings for maximum discretion.</p>
                </div>
                <div>
                  <h3 className="font-semibold text-xl mb-3">Celebrity Look-Alike Escorts</h3>
                  <p className="text-black/70">Girls resembling famous models and influencers.</p>
                </div>
              </div>
            </div>
            <div className="md:col-span-5">
              <Image src="/m21.jpg" alt="VIP Escorts DHA Karachi" width={600} height={800} className="rounded-3xl shadow-2xl" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-zinc-50">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-center mb-12">Areas We Cover in DHA Karachi</h2>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-center">
            {["DHA Phase 1", "DHA Phase 2", "DHA Phase 3", "DHA Phase 4", "DHA Phase 5", "DHA Phase 6", "DHA Phase 7", "DHA Phase 8"].map((phase) => (
              <div key={phase} className="bg-white py-5 rounded-2xl shadow-sm font-medium">{phase}</div>
            ))}
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-center mb-12">Pricing for Escorts in DHA Karachi</h2>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-center mb-12">Our Beautiful Companions in DHA</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[22,23,24,25,26,27,28,29].map((n) => (
              <div key={n} className="relative aspect-square rounded-3xl overflow-hidden shadow-lg">
                <Image 
                  src={`/m${n}.jpg`} 
                  alt="DHA Escorts Karachi" 
                  fill 
      ...
      <section className="py-24 bg-black text-white text-center">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-5xl font-bold tracking-tighter mb-6">Ready to Book Escorts in DHA Karachi?</h2>
