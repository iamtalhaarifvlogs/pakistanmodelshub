    ...
    <main className="bg-white text-black font-sans overflow-hidden">
      ...
      <section className="relative h-screen flex items-center justify-center pt-20">
        <div className="absolute inset-0 z-0">
          <Image 
            src="/m8.jpg" 
            alt="Karachi Escorts in DHA - VIP Companions"
            fill 
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="prose prose-lg max-w-4xl mx-auto text-black/80 leading-relaxed space-y-6">
            <p>
              ...
              in DHA Phase 2, 5, 6, 7, 8 and surrounding areas.
            </p>
            <p>
              DHA is one of the most prestigious residential areas in Karachi. 
              Our high-class DHA Escorts cater to clients looking for VIP, safe, and luxurious companionship.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-12 gap-12 items-center">
            <div className="md:col-span-7">
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <p className="text-black/70">Professional and discreet escorts available for DHA hotels.</p>
                </div>
                <div>
            ...
            <div className="md:col-span-5">
              <Image src="/m9.jpg" alt="VIP Escorts DHA Karachi" width={600} height={800} className="rounded-3xl shadow-2xl" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-zinc-50">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-center">
            {["DHA Phase 2", "DHA Phase 5", "DHA Phase 6", "DHA Phase 7", "DHA Phase 8", "DHA Phase 1"].map((area) => (
