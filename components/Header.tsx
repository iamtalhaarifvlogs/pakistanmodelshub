...
export default function Header() {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:block">
            <a 
              ...
              className="bg-red-600 hover:bg-black text-white px-6 py-2.5 rounded-full font-semibold transition-all duration-300 text-xs tracking-wider shadow-md hover:shadow-lg transform active:scale-95 block"
            >
              CALL 0310-444-1188
            </a>
          </div>
      ...
      {/* Floating Bottom-Left Social Buttons */}
      <div className="fixed bottom-6 left-6 z-40 flex flex-col gap-3">
        {socialLinks.map((social) => (
          <a
            ...
            className="w-11 h-11 flex items-center justify-center rounded-full bg-white/95 text-yellow-600 border border-yellow-500 shadow-lg hover:bg-yellow-500 hover:text-black hover:scale-110 active:scale-95 transition-all duration-300 backdrop-blur-sm"
          >
            {social.icon}
          </a>
        ))}
